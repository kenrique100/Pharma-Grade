    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-3">
          <input
            ...
            placeholder="Search products..." className="bg-gray-700 border border-gray-600 text-white rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-red-500 w-48"
          />
      ...
      {showForm && (
        <div className="fixed inset-0 bg-black/60 z-50 flex items-start justify-center p-4 overflow-y-auto">
          <div className="bg-gray-800 rounded-2xl p-6 border border-gray-700 w-full max-w-2xl my-8">
            <h2 className="text-white font-bold text-lg mb-5">{editing ? "Edit Product" : "Add New Product"}</h2>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-gray-300 text-xs font-medium mb-1">Price (USD) *</label>
                ...
                <div>
                  <label className="block text-gray-300 text-xs font-medium mb-1">Original Price (if on sale)</label>
                ...
                <div>
                  <label className="block text-gray-300 text-xs font-medium mb-1">Promotion Type</label>
                ...
                <div>
                  <label className="block text-gray-300 text-xs font-medium mb-1">Promotion Value</label>
                ...
                <div className="col-span-2">
                  <label className="block text-gray-300 text-xs font-medium mb-1">Product Image URL</label>
                  ...
                  <p className="text-gray-500 text-xs mt-1">Use /images/products/filename.webp for uploaded images, or an external URL.</p>
                </div>
                <div className="col-span-2">
                ...
                <div className="col-span-2 flex items-center gap-3">
                  ...
                  <span className="text-gray-300 text-sm">{form.inStock ? "In Stock" : "Out of Stock"}</span>
                </div>
              </div>
              <div className="flex gap-3 pt-2">
                ...
                <button type="button" onClick={() => { setShowForm(false); setEditing(null); }} className="px-6 bg-gray-700 hover:bg-gray-600 text-white font-bold py-2.5 rounded-lg transition-colors text-sm">Cancel</button>
              </div>
            </form>
          </div>
        </div>
      ...
      <div className="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden">
        <div className="p-4 border-b border-gray-700 flex items-center justify-between">
          ...
          <Link href="/admin/categories" className="text-red-400 hover:text-red-300 text-sm font-medium">Manage Categories →</Link>
        </div>
          ...
          <table className="w-full">
            ...
            <tbody>
              {filtered.map((product) => (
                <tr key={product.id} className="border-b border-gray-700/50 text-sm hover:bg-gray-750">
                  <td className="p-4">
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 bg-gray-900 rounded-lg flex items-center justify-center text-lg flex-shrink-0">
                  ...
                  <td className="p-4">
                    ...
                    {product.originalPrice && <div className="text-gray-500 text-xs line-through">${product.originalPrice}</div>}
                  </td>
                  <td className="p-4 text-gray-400 text-xs">
                    {product.promotionType !== "none" ? (
                      <span className="px-2 py-0.5 bg-orange-900/30 text-orange-400 rounded-full">
                  ...
                  <td className="p-4">
                    <div className="flex gap-2">
                      ...
                      <button onClick={() => openEdit(product)} className="text-yellow-400 hover:text-yellow-300 text-xs font-medium">Edit</button>
                      <button onClick={() => handleDelete(product.id, product.name)} className="text-red-400 hover:text-red-300 text-xs font-medium">Delete</button>
                    </div>
                  </td>
                </tr>
              ))}
