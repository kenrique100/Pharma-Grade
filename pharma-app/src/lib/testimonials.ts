...
const defaultTestimonials: Testimony[] = [
  ...
  },
  {
    ...
    avatar: "",
    rating: 5,
    text: "Nolvadex 20mg is essential for my PCT. This is the most reliable source I've found — consistent quality and fast delivery every time.",
    product: "Nolvadex 20mg",
    date: "2025-02-18",
  },
  {
    id: "8",
    ...
    avatar: "",
    rating: 4,
    text: "Ordered Clomid 50mg for post-cycle therapy. Product was well-packaged and arrived within a week. Very satisfied with the results.",
    product: "Clomid 50mg",
    date: "2025-02-25",
  },
  {
    ...
    avatar: "",
    rating: 5,
    text: "Trenbolone Acetate 100 delivered incredible results in just 4 weeks. Strength and vascularity went through the roof. Highly recommended.",
    product: "Trenbolone Acetate 100",
    date: "2025-03-02",
  },
  {
    id: "10",
    ...
    avatar: "",
    rating: 5,
    text: "TB-500 helped my knee recover faster than anything else I've tried. Customer support answered all my dosage questions promptly.",
    product: "TB-500 5mg",
    date: "2025-03-08",
  },
  {
    ...
    avatar: "",
    rating: 4,
    text: "Winstrol 50mg gave me the dry, lean look I was going for. Quality is pharmaceutical grade, just as advertised. Will reorder soon.",
    product: "Winstrol 50mg",
    date: "2025-03-15",
  },
  {
    id: "12",
    ...
    avatar: "",
    rating: 5,
    text: "Sustanon 270 blend is smooth with minimal PIP. Steady energy and strength gains throughout my cycle. Outstanding product quality.",
    product: "Sustanon 270",
    date: "2025-03-20",
  },
];
